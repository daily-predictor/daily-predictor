#!/usr/bin/env python3
"""Handball prediction model using Poisson distribution."""
import math

HOME_ADV = 1.12
LEAGUE_AVG_GOALS = 55.0
MAX_GOALS = 6
...
def extract_team_stats_from_api(fixture_data, team_stats_response):
    ...
    try:
        ...
        goals_for = stats.get("goals", {}).get("for", {}).get("average", {}).get("total", 27.5)
        goals_against = stats.get("goals", {}).get("against", {}).get("average", {}).get("total", 27.5)
